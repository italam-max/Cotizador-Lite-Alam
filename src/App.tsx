...
export default function App() {
  const { user, profile, loading, isLoggedIn, login, logout, refreshProfile } = useAuth();
  ...
  return (
    ...
    <>
      ...
      >
        ...
        {view === 'new-quote' && (
          <QuoteForm quote={null} sellerName={displayName} sellerTitle={displayTitle}
            onSaved={goBack} onCancel={goBack}
            onToastSuccess={toast.success} onToastError={toast.error} />
        )}
        {view === 'edit-quote' && activeQuote && (
          <QuoteForm quote={activeQuote} sellerName={displayName} sellerTitle={displayTitle}
            onSaved={goBack} onCancel={goBack}
            onToastSuccess={toast.success} onToastError={toast.error} />
        )}
        ...
        {view === 'users' && profile?.role === 'admin' && user && (
          <UsersPage
